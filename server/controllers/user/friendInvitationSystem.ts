...
const addFriend = async (req: IRequest, res: Response) => {
...
const cancelRequest = async (req: IRequest, res: Response) => {
  try {
    if (req.user.id !== req.params.id) {
      const sender = await User.findById(req.user.id);
      const receiver = await User.findById(req.params.id);
...
const follow = async (req: IRequest, res: Response) => {
  try {
    if (req.user.id !== req.params.id) {
      const sender = await User.findById(req.user.id);
      const receiver = await User.findById(req.params.id);
...
const unfollow = async (req: IRequest, res: Response) => {
  try {
    if (req.user.id !== req.params.id) {
      const sender = await User.findById(req.user.id);
      const receiver = await User.findById(req.params.id);
...
const acceptRequest = async (req: IRequest, res: Response) => {
  try {
    if (req.user.id !== req.params.id) {
...
const unfriend = async (req: IRequest, res: Response) => {
  try {
    if (req.user.id !== req.params.id) {
      const sender = await User.findById(req.user.id);
      const receiver = await User.findById(req.params.id);
...
const deleteRequest = async (req: IRequest, res: Response) => {
  try {
    if (req.user.id !== req.params.id) {
      const receiver = await User.findById(req.user.id);
      const sender = await User.findById(req.params.id);
